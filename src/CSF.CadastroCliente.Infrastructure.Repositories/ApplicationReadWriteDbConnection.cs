...
namespace CSF.CadastroCliente.Infrastructure
{
    public class ApplicationReadWriteDbConnection : IApplicationReadWriteDbConnection
    {
        private readonly IApplicationDbContext context;

        public ApplicationReadWriteDbConnection(IApplicationDbContext context)
        {
